...
import { CustomerService } from '../services/CustomarServices';
...
export default function CustomTableForNothing() {
    ...
    return (
        <div className="card">
            <DataTable value={customers} paginator rows={10} dataKey="id" filters={filters} onFilter={handleOnFilter} filterDisplay="row" loading={loading}
